...
| **monitoring_alertmanager_domain** | `http://{{ monitoring_domain }}:`<br>`{{ monitoring_alertmanager_port }}` | Alertmanager web path |
...
|**monitoring_alert_ssl_expire_time**|86400|Alerting time before sertificate will expire|
